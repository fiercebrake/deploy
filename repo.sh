...
function get_package() {
  ...
  case $1 in
    linux-tkg)
      /usr/bin/cp /mnt/tkg/repo-$1.cfg /mnt/tkg/$1/customization.cfg
      ;;
    nvidia-all)
      /usr/bin/cp /mnt/tkg/repo-$1.cfg /mnt/tkg/$1/customization.cfg
      ;;
    wine-tkg-git)
      folder=$1/$1
      /usr/bin/cp /mnt/tkg/repo-$1.cfg /mnt/tkg/$1/$1/customization.cfg
      /usr/bin/cp /mnt/tkg/repo-proton-tkg.cfg /mnt/tkg/$1/proton-tkg/proton-tkg.cfg
      ;;
  esac
